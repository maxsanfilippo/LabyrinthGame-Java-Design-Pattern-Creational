...
public abstract class RobotArtificialIntelligence
{
	...
	public static RobotArtificialIntelligence makeRAI(String nameAI)
	{
		RobotArtificialIntelligence newRAI;
		switch (nameAI)
		{
		case "LDBAI":
			newRAI = new LesserDumbBotArtificialIntelligence();
			break;
		case "DBAI":
			newRAI = new DumbBotArtificialIntelligence();
			break;
		default:
			newRAI = null;
		}
